...
intersection(V1,V2,E1,E2):-i_vertexes(V1,V2,V3),i_edges(E1,E2,E3),write("РІРµСЂС€РёРЅС‹:"),write(V3),nl,write("СЂРµР±СЂР°:"),nl,write(E3),nl.
